...
const BOT_NAME_FANCY = '©MADUSANKA-MD 🇱🇰';
...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://i.ibb.co/GvZKrTqm/08f3449a6539.jpg',
  NEWSLETTER_JID: [
      '120363428670000697@newsletter','120363161833328112@newsletter'],
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',') : ['94787940686','94781629812'],
  ...
  IMAGE_PATH: 'https://i.ibb.co/GvZKrTqm/08f3449a6539.jpg',
...
✨ 𝗦𝘆𝘀𝘁𝗲𝗺 𝗶𝘀 𝗻𝗼𝘄 𝗼𝗻𝗹𝗶𝗻𝗲 & 𝗿𝗲𝗮𝗱𝘆! ©MADUSANKA-MD 🇱🇰`,
  useBotName
);
...
case 'gpt': {
  try {
    ...
    let botName = cfg.botName || '©MADUSANKA-MD 🇱🇰';
...
I’m not just another face in the crowd — I’m ©MADUSANKA-MD 🇱🇰, a self-made digital warrior. Born in the shadows of struggle, but trained in the light of purpose. I live not to follow trends, but to create legacies. I’ve made a vow: To rise, no matter how deep the fall.
...
Bot Creator & DevOps:
I’m the mind behind ©MADUSANKA-MD 🇱🇰 — a multi-functional WhatsApp bot featuring custom commands, automation, and system control. From .news to .apk, my bot does it all.
...
> “When the world turns dark, I don’t hide — I evolve. I am not afraid to walk alone in the shadows. I am the shadow. I am 🫰©MADUSANKA-MD 🇱🇰.”
...
*𖹭 deploy .ᐟ _©MADUSANKA-MD 🇱🇰ᴏᴡɴᴇʀꜱ/madusanka,dct dula dev_*
╰──────────────────────────────╯`;

    const footer = `*©MADUSANKA-MD 🇱🇰 ⚙️*\n${config.BOT_FOOTER}`;

    await socket.sendMessage(sender, {
        image: { url: 'https://i.ibb.co/GvZKrTqm/08f3449a6539.jpg' },
        caption: caption,
        contextInfo: {
...
break;
  ...
  try {
    ...
    const title = userCfg.botName || '©MADUSANKA-MD 🇱🇰';
    
    // 1. GENERATE RANDOM LOGO (Add your URLs here)
    const logos = [
        "https://i.ibb.co/GvZKrTqm/08f3449a6539.jpg", 
        "https://i.ibb.co/GvZKrTqm/08f3449a6539.jpg",
...
`.trim();
    ...
    await socket.sendMessage(sender, {
      ...
      footer: "> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ©MADUSANKA-MD 🇱🇰*",
      contextInfo: {
        externalAdReply: {
  ...
  break;
    ...
    try {       
        ...
        // --- ⚙️ BOT CONFIGURATION ---
        const BOT_NAME = '©MADUSANKA-MD 🇱🇰';
        const OWNER_NAME = '©MADUSANKA-MD 🇱🇰';
        const CHANNEL_LINK = "https://whatsapp.com/channel/0029Vb7y6JB1yT20bJxMcP45";
        const MENU_IMG = "https://i.ibb.co/GvZKrTqm/08f3449a6539.jpg"; 
        // 👇 Video Note URL
...
*╭─「 ©MADUSANKA-MD 🇱🇰-𝐌𝙳 𝐁𝙾𝚃 𝐒ᴛᴀᴛᴜꜱ 」─●●►*
*┃✯╭──────────────┈⊷*
*┃✯┋ 🌏* *\`ɢʀᴇᴇᴛɪɴɢ:\`* *\`${greetingText}\`*
*┃✯┋ 📄* *\`ʙᴏᴛ ɴᴀᴍᴇ:\`* *©MADUSANKA-MD 🇱🇰*
*┃✯┋ 🥷* *\`ᴏᴡɴᴇʀ :\`* *DAMITH 🇱🇰*
*┃✯┋ 💾* *\`ʀᴀᴍ :\`* *\`${ramUsage}MB\`*
*┃✯┋ ⏳* *\`ᴜᴘᴛɪᴍᴇ:\`* *${runtime}*
*┃✯╰────────┈⊷*
...
*👋 හායි ${userTag} welcome to ©MADUSANKA-MD 🇱🇰ᴠ.1 mini බොට් 𝙼𝙴𝙽𝚄 වෙත ඔබව සාදරයෙන් පිලිගන්නවා...❒*



> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ©MADUSANKA-MD 🇱🇰*
...
`.trim();
    ...
    await socket.sendMessage(sender, {
      image: { url: randomLogo }, // Main Logo
      caption: text,
      footer: "🚀 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ©MADUSANKA-MD 🇱🇰",
      buttons: buttons,
      contextInfo: {
        externalAdReply: {
          title: "📥 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐌𝐀𝐍𝐀𝐆𝐄𝐑",
  ...
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '©MADUSANKA-MD 🇱🇰';
  ...
  break;
        ...
        case 'upload': {
          ...
          const metaQuote = {
            ...
            message: { contactMessage: { displayName: "©MADUSANKA-MD 🇱🇰", vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Upload Service\nORG:Catbox/ImgBB\nEND:VCARD` } }
          };
...
`.trim();
  ...
  break;
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '©MADUSANKA-MD 🇱🇰'; // dynamic bot name
...
`;
  ...
  break;
    ...
    try {
        // ✅ NEW API URL UPDATED
        const url = `https://madusanka-md-production.up.railway.app/code?number=${encodeURIComponent(number)}`;
...
case 'alive': {
        ...
        case 'owner': {
          ...
          // ✅ OWNER DETAILS
          const ownerName = "©MADUSANKA-MD 🇱🇰";
          const ownerNumber = "94787940686"; // without +
          const displayNumber = "+94 78 794 0686";
          const email = "madusanka-md-owner@email.com"; // optional
...
🔹 *BOT NAME:*  ${cfg.botName || '©MADUSANKA-MD 🇱🇰'}
   .setbotname <name>
...
> Channel data retrieved successfully`;
        ...
        case 'unfollow': {
          try {
            ...
            if (!channelLink || !channelLink.trim()) {
              return await socket.sendMessage(sender, {
                text: `❌ *Channel Link Required!*\n\n📝 Usage: .unfollow <channel_link>\n\n🔗 *Examples:*\n• .unfollow https://whatsapp.com/channel/0029VbDMF0m30LKKNrmNGc3g\n• .unfollow 120363409799616869@newsletter`
              }, { quoted: msg });
            }
        ...
        case 'follow': {
          try {
            ...
            if (!channelLink || !channelLink.trim()) {
              return await socket.sendMessage(sender, {
                text: `❌ *Channel Link Required!*\n\n📝 Usage: .channelfollow <channel_link>\n\n🔗 *Examples:*\n• .channelfollow https://whatsapp.com/channel/0029VbDMF0m30LKKNrmNGc3g\n• .channelfollow 120363409799616869@newsletter\n• .channelfollow https://chat.whatsapp.com/channel/0029VbBivQGBKfi1VaWyEd0t`
              }, { quoted: msg });
            }
...
case 'song': {
  ...
  try {
    ...
    const caption = `*©MADUSANKA-MD 🇱🇰 𝗦ᴏɴɢ 𝗗ᴏᴡɴʟᴏᴀᴅᴇʀ*
...
case 'video': {
  ...
  try {
    ...
    const caption = `*🎬 𝐕𝐈𝐃𝐄𝐎  𝗗ᴏᴡɴʟᴏᴀᴅᴇʀ ??*
